...
<?php while ($ligne = $stmt->fetch_assoc()) { ?>
    <tr>
        ...
        <td><?php echo $ligne['Séance']?></td>
        <td><?php echo $ligne['Salle']?></td>
        <td><?php echo $ligne['NDist']?></td>
        <td><?php echo $ligne['Groupe']?></td>

        <td> <a class="btn btn-success" href='update?Jour=<?php echo $ligne['Jour']; ?>'><i class="fa-solid fa-file-plus-minus">modifier</i>&nbsp
             <a class="btn btn-danger" href='DeleteO.php?Jour=<?php echo $ligne['Jour']; ?>'>suprimer</a></td>
