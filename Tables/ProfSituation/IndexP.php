...
<table  class="table-bordered"  id="tab2">
    <thead >
    <tr>
                    <th  class="text-center">Code Prof</th>
...
<?php while ($ligne = $stmt->fetch_assoc()) { ?>
    <tr>
            <td><?php echo $ligne['CodeProf'] ?></td>
              <td><?php echo $ligne['Sess'] ?></td>
              <td><?php echo $ligne['Situation']?></td>
              <td><?php echo $ligne['Grade'] ?></td>
                <td> <a class="btn btn-success" href='EditP.php?codeProf=<?php echo $ligne['CodeProf'] ?>'>Modifier</a>&nbsp
                        <a class="btn btn-danger" href='DeleteP.php?codeProf=<?php echo $ligne['CodeProf']  ?>'>supprimer</a>
                        </td>
            </tr>
