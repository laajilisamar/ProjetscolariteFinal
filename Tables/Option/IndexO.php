...
<?php while ($ligne = $stmt->fetch_assoc()) { ?>
    <tr>
        <td><?php echo $ligne['Code_Option']?></td>
        <td><?php echo $ligne['Option_Name']?></td>
        <td><?php echo $ligne['Departement']?></td>
        <td><?php echo $ligne['Option_AraB']?></td>

        <td> <a class="btn btn-success" href='EditO.php?Code_Option=<?php echo $ligne['Code_Option']; ?>'><i class="fa-solid fa-file-plus-minus">modifier</i>&nbsp
             <a class="btn btn-danger" href='DeleteO.php?Code_Option=<?php echo $ligne['Code_Option']; ?>'>suprimer</a></td>
