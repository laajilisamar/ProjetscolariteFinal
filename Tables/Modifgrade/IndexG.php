...
<thead >
    <tr>
        <th class="text-center">NGmodif</th>
        <th class="text-center">Grade</th>
        <th class="text-center">dateNomin</th>
...
<?php while ($ligne = $stmt->fetch_assoc()) { ?>
    <tr>
        <td><?php echo $ligne['NGmodif'] ?></td>
        <td><?php echo $ligne['Grade'] ?></td>
        <td><?php echo $ligne['DateNomin']?></td>
        <td><?php echo $ligne['MatProf'] ?></td>
        <td> <a class="btn btn-success" href='EditG.php?NGmodif=<?php echo $ligne['NGmodif'] ; ?>'>modifier</i>&nbsp
                        <a  class="btn btn-danger"href='DeleteG.php?NGmodif=<?php echo $ligne['NGmodif'];?>'>suprimer</a></td>
